...
intersphinx_mapping = {
    ...
    "numpy": (
        ...
        (None, "intersphinx/numpy-objects.inv"),
    ),
    "matplotlib": (
...
man_pages = [(master_doc, "arc", "ARC Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "ARC",
        "Atom calculator Documentation",
        author,
        "ARC",
        "Alkali Rydberg Calculator - properties of alkali atoms",
        "atomic physics",
    ),
]
